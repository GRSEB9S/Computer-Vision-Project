...
for i = 1:19635
    ...
    if strncmpi(list(randind(i)).name, 'epi', 3) == 1
        feat1 = [feat1; color_feature_descriptor(tile)];
    elseif strncmpi(list(randind(i)).name, 'fib', 3) == 1
        feat2 = [feat2; color_feature_descriptor(tile)];
    elseif strncmpi(list(randind(i)).name, 'inf', 3) == 1
        feat3 = [feat3; color_feature_descriptor(tile)];
    elseif strncmpi(list(randind(i)).name, 'oth', 3) == 1
        feat4 = [feat4; color_feature_descriptor(tile)];
    end
end
